...
- **Database**: MongoDB
- **AI**: Gemini 2.5 Flash (`gemini-2.5-flash`) via `emergentintegrations` + Universal Emergent LLM key
...
## Key Features
- **AI question generation** via Gemini 2.5 Flash with vision support (OCR Hindi/English textbook images).
